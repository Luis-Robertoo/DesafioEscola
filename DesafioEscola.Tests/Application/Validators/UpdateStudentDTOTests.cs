...
public class UpdateStudentDTOTests
{
    private readonly UpdateStudentDTOValidator _validator; 

    public UpdateStudentDTOTests()
    {
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", Password = "Senha@1234", User = "James42", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "Jam", User = "James", Password = "Senha@1234", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = null, User = "James", Password = "Senha@1234", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "Jam", Password = "Senha@1234", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = null, Password = "Senha@1234", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = "", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = null, Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = "Se@1", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = "Senha@1234789", Active = true, Id = 1 };
    ...
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = "12345678", Active = true, Id = 1 };
    ...
    [Fact]
    public void Deve_Validar_Se_Id_E_Nulo()
    {
        //Arrange
        var dto = new UpdateStudentDTO { Name = "James", User = "James", Password = "Senha@1234", Active = true };
        ...
        //Assert
        Assert.False(result.IsValid);
        Assert.True(result.Errors.Where(e => e.ErrorMessage.Contains("O Id do aluno não pode estar vazio")).Count() == 1);
    }
}
